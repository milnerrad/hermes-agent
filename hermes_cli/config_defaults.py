...
DEFAULT_CONFIG = {
    ...
    "telegram": {
        ...
        "allow_guest_queries": False,   # Bot API Guest Queries are an explicit trust-boundary opt-in
        "guest_query_rate_limit_per_minute": 5,  # Per sender+chat intake ceiling when enabled
        "extra": {
